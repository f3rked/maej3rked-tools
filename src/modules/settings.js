...
export const soundSettingsMap = () => {
  return {
    ...
    "global-missions": {
      ...
      "label": "Disable Global Mission Sounds",
      "type": "toggle",
    ...
    "leveling": {
      ...
      "matching": "xp.*|level.*|daily",
      "name": "levelingSounds",
      "label": "Disable Leveling Sounds",
      "type": "toggle",
    ...
    "nav": {
      ...
      "name": "navSounds",
      "label": "Disable Navigation Sounds",
      "type": "toggle",
    ...
    "items": {
      ...
      "matching": "item.*",
      "name": "itemsSounds",
      "label": "Disable Item Sounds",
      "type": "toggle",
      "value": config.get("itemsSounds"),
      "group": "customize-sound-effects",
      "help": {
        "label": "?",
        "text": `<p>Item found, craft success, craft fail, consumed item</p>`,
      },
    }
  }
}
